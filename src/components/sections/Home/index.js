        ...
        return (
            <section className="section home-section">
                <div className="fresh-news-badge">
                    ...
                    <span className="news-title">{this.state.news.Body}</span>
                </div>
                <div className="jumbotron-block">
                    <h2 className="jumbotron-heading">
                        Unlock innovation by removing collaboration barriers
                    </h2>
                    <p className="jumbotron-paragraph">
                        Collaboration platform powered by community-generated
                        smart contracts for entrepreneurs, backers and creative
                        individuals.
                    </p>
                </div>
                <button
